...
>
	<div class="mb-6 md:mb-0">
		<h2 class="text-base-content text-4xl mb-8 md:mb-10 text-center italic">SoundCloud</h2>
	...
	<div>
		<h2 class="text-base-content text-4xl mb-8 md:mb-10 text-center italic">Audius</h2>
		<div class="frame-wrapper flex justify-center">
			<iframe
				class="rounded-xl"
				title="Obsessed"
